...
function check_necessary_variables {
    ...
    if [ "$1" = "JENKINS"  ]; then
        ...
        DB_MIG_REPO=ssh://git@gitea.example1-test.com:222/${MY_USER}/${DB_MIG_NAME}.git
        BACK_REPO=ssh://git@gitea.example1-test.com:222/${MY_USER}/${BACK_NAME}.git
        FRONT_REPO=ssh://git@gitea.example1-test.com:222/${MY_USER}/${FRONT_NAME}.git
        DEVOPS_REPO=ssh://git@gitea.example1-test.com:222/${MY_USER}/${DEVOPS_NAME}.git
    fi
}